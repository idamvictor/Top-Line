...
const Page = () => {
  return (
    <section className='px-5 lg:px-10 space-y-28 '>
      <Hero />
      <GetSatrted />
      <Benefit />
      <QrContainer />
     ...
     <section className='md:px-5 lg:px-10 relative text-white  flex w-full justify-center items-center min-h-fit 2xl:max-h-[700px]  md:h-[85vh]'>
       <main className=' flex w-full gap-y-5 justify-between md:h-[80vh]  max-md:flex-col md:max-h-[600px]  '>
         ...
         <div className='flex-1 flex justify-start  items-center '>
           <div className='image h-full w-full max-w-[700px] rounded-xl max-h-[700px] bg-background overflow-hidden'>
             <Image
             src={heroImg}
             alt="image"
             className="w-full h-full object-fill bg-background"/>
           </div>
         </div>
       </main>
     </section>
...
const GetSatrted = () => {
  return (
    <section className='What_We_offer text-slate-300 my-10 '>
      ...
      <p className='my-5 font-light text-base '>
        ...
        Telegram channel. Once there, {"you'll"} receive detailed information on
        how our service works, including insights into our investment strategies
        and how we manage client capital.
      </p>
      <div className='py-5'>
...
//                Capital Management
//              </h1>
//              <p className=' text-slate-400 text-base lg:text-base 2xl:text-lg '>
//                {text}
//              </p>
//              <Button
...
//         <div className='flex-1 flex justify-start  items-center '>
//           <div
//             className='image h-full w-full max-w-[700px] overflow-hidden rounded-xl max-h-[700px] min-h-[500px] bg-background'
//             data-aos='zoom-in'
//             data-aos-offset='0'
//           >
//              <Image
//              src={heroImg}
//              alt="image"
//              className="w-full h-full object-fill bg-background opacity-55"/>
//           </div>
//         </div>
//       </main>
//     </section>
