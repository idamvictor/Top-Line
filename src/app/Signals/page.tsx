...
import signalHero from  '@/../public/assets/signalHero.png'
...
const Hero = () => {
    ...
    return (
      <section
        className="signalHero  px-5 lg:px-10 relative text-white flex w-full justify-center items-center min-h-fit h-[80vh] 2xl:max-h-[600px]  md:h-[80vh] md:max-h-[600px]"
      >
        <main className=" flex w-full justify-between md:h-[70%] gap-y-5 max-md:flex-col md:max-h-[500px]  ">
