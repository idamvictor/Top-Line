...
const Hero = () => {
  const text =
      ...
      return (
    <section className=' exchangeHero bg-background  px-5 lg:px-10 relative text-white flex w-full justify-center items-center min-h-fit h-[80vh] 2xl:max-h-[600px]  md:h-[80vh] md:max-h-[600px]'>
