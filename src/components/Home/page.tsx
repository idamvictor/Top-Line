...
const HeroUi = () => {
  return (
    <section className='md:pb-[18rem] lg:pb-28 relative '>
      <SwipeCarousel />
      <div
        className='txt-btn absolute top-0 w-full  sm:h-[50%] md:h-[50%] lg:h-[60%] flex justify-center items-center '
        data-aos='zoom-out-right'
      >
        <div className='container text-center space-y-5 max-w-[800px] text-white mt-10'>
          <p className=' font-bold text-xs pb-0 sm:text-sm md:text-base md:pb-5'>
  ...
  return (
    <>
      ...
      <p className=' text-xs sm:text-sm font-normal '>
        ...
        content that represents different cultures and perspectives. is uniquely
        positioned to meet this demand by highlighting African content and
        talent, alongside
      </p>
    </>
  );
